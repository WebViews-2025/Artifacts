...
class GeckoViewCheckerChecker:
    def __init__(self, lock):
        self.base_store_path = ""
        self.base_results_file = "geckoview_analysis.csv"
    ...
    def complete_analysis(self, app_id, is_webview_present):
        with self.lock:
            ...
            results_df.loc[
                results_df["app_id"] == app_id, "geckoview_present"
            ] = is_webview_present
...
if __name__ == "__main__":
    with Manager() as manager:
        lock = manager.Lock()
        checker = GeckoViewCheckerChecker(lock)
        checker.main()
